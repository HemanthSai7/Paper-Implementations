...
class MultiHeadAttention(tf.keras.layers.Layer):
    ...
    def compute_output_shape(self, input_shape):
        query_shape = input_shape[0] # (batch, query_seq_len, query_dim)
        
        batch_dim = query_shape[0]
        query_seq_len_dim = query_shape[1]
        query_dim = query_shape[2]
        
        output_feature_dim = self.output_size if self.output_size is not None else query_dim
        
        return (batch_dim, query_seq_len_dim, output_feature_dim)
