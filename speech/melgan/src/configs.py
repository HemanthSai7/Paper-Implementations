...
class LearningConfig:
    def __init__(self, config: dict = None):
        ...
        self.generator_optimizer_config: dict = config.get("generator_optimizer_config", {})
        self.discriminator_optimizer_config: dict = config.get("discriminator_optimizer_config", {})
