...
def main(
    ...
    with strategy.scope():
        model = Moonshine(**config.model_config, vocab_size=tokenizer.vocab_size, tokenizer=tokenizer)
    ...
    callbacks = [
        ...
        # )
        # TensorboardLRCallback(config.learning_config.running_config.tensorboard.log_dir),
        # TimestampCallback(),
    ]
