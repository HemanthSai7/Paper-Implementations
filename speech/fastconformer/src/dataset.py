...
from src.schema import TrainInput, TrainLabel, TrainOutput
...
class ASRDataset(BaseDataset):
    ...
    def process(self, dataset: tf.data.Dataset, batch_size: int, shapes=None):
        ...
        dataset = dataset.padded_batch(
            ...
            padding_values=(
                TrainInput(inputs=0.0, inputs_length=0, predictions=self.tokenizer.blank, predictions_length=0),
                TrainLabel(labels=self.tokenizer.blank, labels_length=0),
            ),
